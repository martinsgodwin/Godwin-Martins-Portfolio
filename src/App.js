        ...
        <section id="home" className="hero">
          <div className="hero-left">
            ...
            <div className="social-links">
              <p>Follow Me</p>
              <div className="icons">
                <a href="https://www.linkedin.com/in/godwin-martins-67597a396" className="social-icon" title="LinkedIn">
                ...
                <a href="https://github.com/Godwin-Martins" className="social-icon" title="GitHub">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
